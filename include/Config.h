#pragma once
//
// Compile-time configuration: pin map and hard safety ceilings. Component
// values and the band table live in core/Components.h so the tuning maths can
...
#include "Components.h"   // relay values and band table (include/core)

namespace atu {

constexpr uint8_t kAntennaPinCount = 3;

constexpr const char* kFirmwareVersion = "2.1";
